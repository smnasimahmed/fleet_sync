...
class MechanicsPersonalInfoPage extends StatelessWidget {
  // final RadioController controller;
  const MechanicsPersonalInfoPage({super.key});
    ...
    return Obx(
      () => Column(
        ...
        children: [
          ...
          _firstAndLastName(),
          CustomTextFormField(title: ConstStrings.shopName),
          CustomTextFormField(title: ConstStrings.typesOfRepairs),
